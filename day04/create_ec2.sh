...
create_ec2_instance() {
    ...
    # Checks whether the $instance_id is empty/null or not
...
main() {
	...
	AMI_ID="ami-04a37924ffe27da53"
    	...
    	SUBNET_ID="subnet-00146c091dfca2398"
    	SECURITY_GROUP_IDS="sg-0b5fbad8e6a81b714"  # Add your security group IDs separated by space
